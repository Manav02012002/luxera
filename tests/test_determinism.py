...
def test_job_determinism_round_trip(tmp_path: Path):
...
""",
    ...
    project = Project(name="Determinism", root_dir=str(tmp_path))
    ...
    # Run again; should reuse cached result and preserve hash
